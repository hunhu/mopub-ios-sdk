...
- (void)hideStatusBar
{
    if (!self.statusBarHidden) {
        ...
        self.applicationHidesStatusBar = NO;//[UIApplication sharedApplication].statusBarHidden;
...
#endif
{
    return UIInterfaceOrientationMaskAll;//([[UIApplication sharedApplication] mp_supportsOrientationMask:self.supportedOrientationMask]) ? self.supportedOrientationMask : UIInterfaceOrientationMaskAll;
}
...
{
    return YES;//[[UIApplication sharedApplication] mp_doesOrientation:interfaceOrientation matchOrientationMask:self.supportedOrientationMask];
}
